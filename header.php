...
<h1 class="m-0 text-center head-logo"><a href="<?php echo $home; ?>"><img src="<?php echo $wp_url; ?>/lib/images/logo.png" srcset="<?php echo $wp_url; ?>/lib/images/logo.png 1x, <?php echo $wp_url; ?>/lib/images/logo@2x.png 2x" alt="日本料理の【姫路瓢亭】会席や接待、法事などにご利用ください"></a></h1>
<nav class="position-absolute d-md-block d-none">
<ul class="list-group list-group-horizontal">
<li class="list-group-item border-0 text-vertical bg-transparent"><a class="text-body" href="<?php echo $home; ?>/">ホーム</a></li>
<li class="list-group-item border-0 text-vertical bg-transparent"><a class="text-body" href="<?php echo $home; ?>/menu/">お品書き</a></li>
<li class="list-group-item border-0 text-vertical bg-transparent"><a class="text-body" href="<?php echo $home; ?>/about/">店舗情報</a></li>
<li class="list-group-item border-0 text-vertical bg-transparent"><a class="text-body" href="<?php echo $home; ?>/about#access">アクセス</a></li>
<li class="list-group-item border-0 text-vertical bg-transparent"><a class="text-body" href="<?php echo $home; ?>/news/">新着情報</a></li>
<li class="list-group-item border-0 text-vertical bg-transparent"><a class="text-body" href="<?php echo $home; ?>/about#recruit-about">求人情報</a></li>
</ul>
</nav>
</div>
...
<div class="d-md-block d-none"><a href="<?php echo $home; ?>"><img src="<?php echo $wp_url; ?>/lib/images/logo.png" alt=""></a></div>
